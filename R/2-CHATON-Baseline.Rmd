---
title: "CHATON Trial Primary Analysis -  Baseline Balance"
...
Summarize baseline characteristics by group in the CHATON trial.
...
table1(~ ageinweek_bl + childsex + weight_3800 + visittype + district + enroll_season| tr, 
       data = d0, 
